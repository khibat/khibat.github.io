window.onload = function () {
    ...
    function showResult() {
        ...
        var head = {
            "w": " Авторитарный стиль",
            "t": " Авторитетный стиль",
            "c": " Либеральный стиль",
            "s": " Индифферентный стиль"
        }
        ...
        if (result_a.length == 2) {
            ...
            div.innerHTML += "<p style='font-weight:bold'>Близкий вам стиль -"+head_a+"</p><br>";
            for (var i = 0; i < result_a.length; i++) {
...
percent.innerHTML = "<p class='percent__p'>Авторитарный стиль: "+w * 10+"%</p><p class='percent__p'>Авторитетный стиль: "+t * 10+"%</p><p class='percent__p'>Либеральный стиль: "+c * 10+"%</p><p class='percent__p'>Индифферентный стиль: "+s * 10+"%</p>";
